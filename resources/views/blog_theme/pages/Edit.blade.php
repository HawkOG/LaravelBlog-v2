...
<form action="/store" method="POST"  class="form-horizontal">
    {{-- {{ csrf_field() }} --}}
    @csrf
    <h2 class="pl-3">Redaguoti įrašą</h2>
    
    <div class="form-group mt-5">
    
        <div class="col-sm-10">
                <label for="">Naujienos pavadinimas</label>
        <input type="text" class="form-control" id="title" name="title" placeholder="Pavadinimas" value={{$post->title}}>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-10">
             ...
             <textarea class="form-control" rows="5" id="body" name="body" placeholder="Turinys" value={{$post->body}}></textarea>
        </div>
    </div>
    <div class="form-group">
                <div class="col-sm-10">
