...
<div class="container">
    ...
    <ul class="navbar-nav ml-auto">
        ...
        <ul class="navbar-nav ml-auto text-light">
            ...
            <li class="nav-item">
                <a class="nav-link" href="#">Hello, <b>{{ Auth::user()->name }}</b></a>
              </li>
            <li class="nav-item"><a class="nav-link" href="/home">Dashboard</a></li>
              <li class="nav-item">
                  <a class="nav-link" href="/posts/create">Create post</a>
                                ...
                                <li class="nav-item text-primary"><a class="pl-3 nav-link" href="{{ route('logout') }}" onclick="event.preventDefault();document.getElementById('logout-form').submit();">Logout</a></li>
